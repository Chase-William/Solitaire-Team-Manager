...
public class LoggoutResultCallback
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Solitaire.LoggoutResultCallback, Solitaire", LoggoutResultCallback.class, __md_methods);
	}


	public LoggoutResultCallback ()
	{
		super ();
		if (getClass () == LoggoutResultCallback.class)
			mono.android.TypeManager.Activate ("Solitaire.LoggoutResultCallback, Solitaire", "", this, new java.lang.Object[] {  });
	}
